...
async def get_gif(ctx, command: str, person: discord.Member | None = None) -> None:
    ...
    try:
        files_all: list[str] = [name for name in os.listdir(media_folder)
